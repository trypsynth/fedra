...
To build Fedra, you will need Rust installed, along with a C++ compiler (MSVC) and CMake for building the dependencies.

```batch
cargo build --release
```

This will generate the executable in `target/release/fedra.exe`.
